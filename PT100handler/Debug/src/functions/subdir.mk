...
/home/johannes/web-plc/firmware/src/functions/PT100functions.c \
...
src/functions/PT100functions.o: /home/johannes/web-plc/firmware/src/functions/PT100functions.c
	@echo 'Building file: $<'
	@echo 'Invoking: Cross GCC Compiler'
	arm-linux-gnueabi-gcc -I/usr/arm-linux-gnueabi/include -I/home/johannes/web-plc/firmware/src/functions -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
