...
wget -nH --directory-prefix=/etc/apache2/sites-enabled/ --cut-dirs=4 -r -np http://HP-Max/wistcon/EL-100-020/vers1_0/apache2setup/000-default
wait
echo "copy set up - file ports.conf"
wget -nH --directory-prefix=/etc/apache2/ --cut-dirs=4 -r -np http://HP-Max/wistcon/EL-100-020/vers1_0/apache2setup/ports.conf
echo "restart apache2"
...
wget -nH --directory-prefix=/etc/apache2/sites-available/ --cut-dirs=4 -r -np http://HP-Max/wistcon/EL-100-020/vers1_0/apache2setup/default-ssl
...
if [ "$RESP" = "y" ]; then
wget -nH --directory-prefix=/tmp/ --cut-dirs=4 -r -np http://HP-Max/wistcon/EL-100-020/vers1_0/apache2setup/set_hostname.sh
wait
cd /tmp/
